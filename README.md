# 🐍 Nokia Snake Game - Gesture Control without mediapipe

[![Python](https://img.shields.io/badge/Python-3.7+-blue.svg)](https://python.org)
[![OpenCV](https://img.shields.io/badge/OpenCV-4.8+-green.svg)](https://opencv.org)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

**Created by Haziqa Shakir Khan**
...
- **fallback hand detection** for real-time gesture recognition
...
2. Return new gesture type in the function
3. Handle new gesture in `main.py` game loop
...
- A passionate learner creating and exploring innovative gaming experiences with AI and computer vision
